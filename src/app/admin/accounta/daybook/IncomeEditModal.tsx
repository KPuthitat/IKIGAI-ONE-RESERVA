...
export default function IncomeEditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-black/40 p-4 overflow-y-auto" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md my-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-slate-100">
          ...
          <button type="button" onClick={save} disabled={busy}
            className="rounded-md bg-brand text-white px-4 py-1.5 text-sm font-medium hover:opacity-90 disabled:opacity-50">
