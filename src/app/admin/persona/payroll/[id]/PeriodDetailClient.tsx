        ...
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-slate-400 leading-relaxed">
            {line.employment_type === "pt"
              ...
              : ftMonthly
              ? <>พนักงานประจำได้เงินเดือนเต็ม (รวมวันหยุด) — ตารางนี้แสดงเฉพาะส่วนที่เพิ่ม/หักจากเงินเดือน (ค่าล่วงเวลา ซึ่งรวมค่าตอบแทนวันจ่ายสองเท่าแล้ว, ลาไม่รับค่าจ้าง −ต่อวัน) ยอดล่างคือยอดจ่ายจริงรอบนี้</>
