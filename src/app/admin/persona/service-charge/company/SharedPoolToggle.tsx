      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          <div className="text-sm font-bold text-slate-800">
            รวมกอง SVC ทั้งบริษัท {shared ? "· เปิดอยู่" : ""}
          </div>
          <div className="text-xs text-slate-500 mt-0.5 max-w-xl">
            เปิดเมื่อทุกสาขาต้องแบ่งเซอร์วิสชาร์จร่วมกัน — เอายอดทุกสาขามารวมกอง แล้ว
            แบ่งตามชั่วโมงทำงานจริงให้ทุกคนที่ทำงานวันนั้น (รวมคนที่ทำสาขาที่ยังไม่มียอด
            เช่น สาขาเปิดใหม่). ตั้งได้เป็นรายเดือน
          </div>
        </div>
        {canEdit ? (
          <button
