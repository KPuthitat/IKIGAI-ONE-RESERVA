...
import { isSalesaBranch, getLineGroupId, getMonthlyTarget, getMerchantName } from "@/lib/salesa-db";
...
export default function ReportaSettingsPage() {
  ...
  return (
    <div className="space-y-4 max-w-xl">
      ...
      <ReportaSettingsClient initialGroupId={getLineGroupId(branchId)} initialTarget={getMonthlyTarget(branchId)} initialMerchant={getMerchantName(branchId)} />
    </div>
  );
}
