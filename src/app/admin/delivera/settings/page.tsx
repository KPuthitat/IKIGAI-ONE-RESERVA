  ...
  return (
    <div className="space-y-4">
      ...
      <SettingsClient
        ...
        menu={listMenu(branchId).map((m) => ({ id: m.id, name_th: m.name_th, category: m.category, description: m.description, price: m.price, is_available: m.is_available === 1, image_url: m.image_url }))}
