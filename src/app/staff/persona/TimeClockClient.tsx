    ...
    return (
      <div className="bg-sky-50 border-2 border-sky-200 rounded-2xl p-4 space-y-3 text-left">
        ...
        <div className="text-sm text-slate-700 leading-relaxed">
          {isOut
            ? `พี่ครับ น้องฮูกมาช่วยเตือนนิดนึงนะครับ — เมื่อวันที่ ${dateLabel} ยังไม่ได้ลงเวลาออกงาน กดปุ่มไปรับรองเวลาออกได้เลยครับ เดี๋ยวน้องช่วยจัดการให้ ทั้งนี้การลงเวลาไม่ครบจะถูกบันทึกเป็นสถิติและอาจมีผลทางวินัย ไม่ได้ปล่อยผ่านนะครับ คราวหน้าอย่าลืมลงเวลาออกทุกครั้งนะครับ`
            : `พี่ครับ น้องฮูกเห็นว่าวันนี้มีลงเวลาออก แต่ยังไม่มีเวลาเข้างานนะครับ กดไปรับรองเวลาเข้าได้เลยครับ เดี๋ยวน้องช่วยจัดการให้ ทั้งนี้การลงเวลาไม่ครบจะถูกบันทึกเป็นสถิติและอาจมีผลทางวินัยนะครับ`}
        </div>
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button
            onClick={onSuccess}
