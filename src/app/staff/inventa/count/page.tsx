    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">
          สแกน QR/บาร์โค้ด หรือเลือกจากรายการ แล้วกรอกจำนวนที่นับได้จริง —
          ระบบบันทึกเป็นยอด ณ วันนับ เพื่อนำไปปรับสต๊อกใน APSX
          (ระบบนี้ไม่ตัดสต๊อกอัตโนมัติ จึงไม่อิงยอดคงเหลือเดิม)
        </p>
      </div>
      <CountClient
        items={items}
