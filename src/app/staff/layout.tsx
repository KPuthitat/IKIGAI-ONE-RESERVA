  ...
  const sections: SidebarSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/staff/persona/payslip", label: "สลิปเงินเดือน" },
        ...
        { href: "/staff/persona/break-skip", label: "ขอทำงานช่วงพัก (ไม่พัก)" },
        { href: "/staff/persona/ot-request", label: "ขอค่าล่วงเวลา (OT) ย้อนหลัง" },
        {
